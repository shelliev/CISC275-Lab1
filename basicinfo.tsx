...
const yourName : String = "Shellie";
let yourPronouns : String = "she/her";
const yourMajor : String = "Computer Science";
let classification : String = "junior";
let oneExcite : String = "Excited to be a part of a group and learn a new language";
let anyConcerns : String = "Not worried yet.";
let funFact : String = "I learned to play the flute since 5th grade.";
